...
## File: src/app/application/__init__.py
```python
"""Application layer use cases (no infrastructure)."""
```

## File: src/app/application/account/__init__.py
```python
# Account bounded context.
```

## File: src/app/application/account/use_cases/__init__.py
```python
# Account use cases.
```

## File: src/app/application/market/__init__.py
```python
"""Market use cases."""
```

## File: src/app/application/market/mappers/__init__.py
```python
"""
...
## File: src/app/application/market/use_cases/__init__.py
```python
# Market use cases.
```

## File: src/app/application/ports/__init__.py
```python
...
## File: src/app/application/system/use_cases/__init__.py
```python
# System use cases.
```

## File: src/app/application/system/use_cases/ping.py
```python
"""
...
## File: src/app/application/trading/__init__.py
```python
"""Trading use cases."""
```

## File: src/app/application/trading/dto/__init__.py
```python
# DTOs for trading application layer.
```

## File: src/app/application/trading/mappers/__init__.py
```python
"""
...
## File: src/app/application/trading/qrl/guards/__init__.py
```python
# QRL guard utilities
```

## File: src/app/application/trading/use_cases/__init__.py
```python
# Trading use cases.
```

## File: src/app/domain/__init__.py
```python
"""Domain layer root."""
```

## File: src/app/domain/aggregates/__init__.py
```python
...
## File: src/app/domain/entities/order_book_level.py
```python
from dataclasses import dataclass
from decimal import Decimal
...
## File: src/app/domain/entities/trading_pair.py
```python
from dataclasses import dataclass
...
## File: src/app/domain/value_objects/api_secret.py
```python
from dataclasses import dataclass
...
## File: src/app/domain/value_objects/side.py
```python
from dataclasses import dataclass
...
## File: src/app/domain/value_objects/sub_account_id.py
```python
from dataclasses import dataclass
...
## File: src/app/infrastructure/__init__.py
```python
"""Infrastructure layer placeholder (no implementations yet)."""
```

## File: src/app/infrastructure/config.py
```python
class Config:
...
## File: src/app/infrastructure/exchange/mexc/adapters/__init__.py
```python
...
## File: src/app/infrastructure/exchange/mexc/qrl/__init__.py
```python
# QRL/USDT dedicated infrastructure components
```

## File: src/app/infrastructure/exchange/mexc/qrl/qrl_settings.py
```python
...
## File: src/app/infrastructure/exchange/mexc/ws_client.py
```python
"""
...
## File: src/app/infrastructure/exchange/mexc/ws/__init__.py
```python
...
## File: src/app/interfaces/__init__.py
```python
...
## File: src/app/interfaces/http/__init__.py
```python
"""HTTP interfaces (controllers only)."""
```

## File: src/app/interfaces/http/api/__init__.py
```python
"""API routers for JSON endpoints."""
```

## File: src/app/interfaces/http/pages/__init__.py
```python
"""HTML page controllers."""
```

## File: src/app/interfaces/http/pages/dashboard_routes.py
```python
...
## File: src/app/interfaces/http/pages/static/js/application/dashboard.js
```javascript

```

## File: src/app/interfaces/http/pages/static/js/core/chart.js
```javascript

```

## File: src/app/interfaces/http/pages/static/js/core/dom.js
```javascript

```

## File: src/app/interfaces/http/pages/static/js/core/http.js
```javascript

```

## File: src/app/interfaces/http/pages/static/js/domain/depth.js
```javascript
...
## File: src/app/interfaces/http/pages/static/js/domain/trade.js
```javascript

```

## File: src/app/interfaces/http/pages/static/js/pages/dashboard-config.js
```javascript
(() => {
...
## File: src/app/interfaces/tasks/market_tasks.py
```python
...
## File: src/app/interfaces/tasks/system_tasks.py
```python
...
## File: src/app/interfaces/tasks/trading_tasks.py
```python
...
## File: src/app/application/market/use_cases/get_depth.py
```python
"""
...
## File: src/app/application/market/use_cases/get_kline.py
```python
"""
...
## File: src/app/application/market/use_cases/get_market_trades.py
```python
"""
...
## File: src/app/application/trading/dtos.py
```python
from dataclasses import asdict, dataclass
...
## File: src/app/application/trading/use_cases/get_price.py
```python
from dataclasses import dataclass
...
## File: src/app/application/trading/use_cases/list_orders.py
```python
...
## File: src/app/domain/value_objects/order_command.py
```python
from dataclasses import dataclass
